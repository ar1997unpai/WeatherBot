...
This is a simple weather application that fetches weather details using the WeatherAPI and displays them to the user.

## Features

- Get weather details for one or multiple cities.
- Caches API responses for faster retrieval.
- Writes weather reports to an external file.
